...
Reusable workflows are maintained as open Agent Skills under `.agents/skills`. Read the matching `SKILL.md` when the task involves code analysis, testing, Docker Compose, GitHub Actions, AWS ECS deployment, documentation, or a documentation-drift audit.
